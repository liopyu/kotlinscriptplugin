...
export default class KotlinParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterParenthesizedDirectlyAssignableExpression(ctx) {
	}

	// Exit a parse tree produced by KotlinParser#parenthesizedDirectlyAssignableExpression.
	exitParenthesizedDirectlyAssignableExpression(ctx) {
	}
	...
	enterParenthesizedAssignableExpression(ctx) {
	}

	// Exit a parse tree produced by KotlinParser#parenthesizedAssignableExpression.
	exitParenthesizedAssignableExpression(ctx) {
	}
