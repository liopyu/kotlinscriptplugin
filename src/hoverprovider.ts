...
export class HoverProviderKS implements vscode.HoverProvider {
    provideHover(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken): vscode.ProviderResult<vscode.Hover> {
        ...
        //logNodeTree(treeProvider.tree.rootNode)
        ...
        const baseType = this.resolveBaseType(node, treeProvider, scope);
        ...
        return new vscode.Hover(this.buildHoverMarkdownType(effectiveBaseType, typingsMember));
    }
    ...
    private buildHoverMarkdownNativeClass(classPath: string, typingsMember: TypingsMember): vscode.MarkdownString {
        ...
        log("isInterface: " + isInterface + ", modifiers: " + typingsMember.modifiers)
    ...
    private buildHoverMarkdownType(classPath: string, typingsMember: TypingsMember): vscode.MarkdownString {
        const markdown = new vscode.MarkdownString(undefined, true);
        markdown.isTrusted = true;
        const isInterface = typingsMember.modifiers?.includes('interface');
        const classKeyword = isInterface ? 'interface' : 'class';
